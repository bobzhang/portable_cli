...
description: Use this when a user asks to pack, bundle, or snapshot a repository or directory into compact Markdown context for an agent, using the portable WASM repopack CLI from this repo.
---
...
needed, preopens the selected workdir, and executes the artifact with Wasmtime:
...
5. If the task requires Git-aware ignores, symlink handling, byte-size limits
